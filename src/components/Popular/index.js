...
class Popular extends Component {
  ...
  getApiCall = async () => {
    ...
    const url = `https://api.themoviedb.org/3/movie/popular?api_key=b9eacb52c8666ad78aa34501c81fbe03&language=en-US&page=${currentPage}`
    ...
    this.setState({popularArray: updatedData, totalPages: data.total_pages})
  }
  ...
  render() {
    const {popularArray, movies, currentPage, currentPageMovie} = this.state
          ...
          <>
            <div className="header">
              {popularArray.length !== 0 && (
                <>
                  <h1 className="titleName">Popular</h1>
